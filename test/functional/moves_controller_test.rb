...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { game_id: @move.game_id, player_id: @move.player_id, position: @move.position, square: @move.square }
    end
  ...
  test "should update move" do
    put :update, id: @move, move: { game_id: @move.game_id, player_id: @move.player_id, position: @move.position, square: @move.square }
    assert_redirected_to move_path(assigns(:move))
  end
